    ...
    data: [
      {
        ...
        aiScore: 94,
        aiVerdict: 'AUTENTICO',
        aiNotes: 'Logotipo e acabamento consistentes.',
        sellerId: seller.id,
      },
      {
        brand: 'Omega',
        ...
        aiScore: 90,
        aiVerdict: 'AUTENTICO',
        aiNotes: 'Ponteiros e bezel coerentes.',
        sellerId: seller.id,
      },
      {
        ...
        aiScore: 96,
        aiVerdict: 'AUTENTICO',
        aiNotes: 'Gravações e acabamento alinhados.',
        sellerId: seller.id,
      },
      {
        ...
        aiScore: 93,
        aiVerdict: 'AUTENTICO',
        aiNotes: 'Textura do dial consistente.',
        sellerId: seller.id,
      },
      {
        brand: 'Cartier',
        ...
        aiScore: 91,
        aiVerdict: 'AUTENTICO',
        aiNotes: 'Acabamento geral consistente.',
        sellerId: seller.id,
      },
      {
        brand: 'TAG Heuer',
        ...
        aiScore: 89,
        aiVerdict: 'AUTENTICO',
        aiNotes: 'Materiais aparentes originais.',
        sellerId: seller.id,
      },
    ],
  });
